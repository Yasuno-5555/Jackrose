...
The [default config](https://github.com/Yasuno-5555/Jackrose/blob/main/resources/default-config.kdl) is intended to give a familiar, helpful, and not too jarring experience to new users.
