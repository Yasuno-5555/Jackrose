# Jackrose Live Install Trial Checklist
...
- Verified Jackrose rootfs sandbox matches current release.
...
- [ ] **Startup Options Handoff**: Manually reboot system, select Jackrose target, and confirm Jackrose Welcome wizard launches on first startup.
